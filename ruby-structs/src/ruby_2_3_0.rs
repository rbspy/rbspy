...
fn bindgen_test_layout_st_table__bindgen_ty_1__bindgen_ty_1() {
    ...
    test_field_bins();
    fn test_field_private_list_head() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<st_table__bindgen_ty_1__bindgen_ty_1>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).private_list_head) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_rb_thread_struct() {
    ...
    fn test_field_interrupt_cond() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_thread_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).interrupt_cond) as usize - ptr as usize
            },
            344usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_rb_compile_option_struct() {
    ...
    fn test_field_frozen_string_literal() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_compile_option_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).frozen_string_literal) as usize - ptr as usize
            },
            32usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_frozen_string_literal();
    fn test_field_debug_frozen_string_literal() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_compile_option_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).debug_frozen_string_literal) as usize - ptr as usize
            },
            36usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_debug_frozen_string_literal();
