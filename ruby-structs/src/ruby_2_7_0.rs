...
fn bindgen_test_layout_rb_call_data() {
    ...
    fn test_field_cc() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_call_data>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_rb_global_vm_lock_struct() {
    ...
    fn test_field_waitq() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_global_vm_lock_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).waitq) as usize - ptr as usize
            },
            48usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_timer();
    fn test_field_timer_err() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_global_vm_lock_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).timer_err) as usize - ptr as usize
            },
            72usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_rb_iseq_constant_body() {
    ...
    test_field_jit_unit();
    fn test_field_iseq_unique_id() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_iseq_constant_body>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).iseq_unique_id) as usize - ptr as usize
            },
            280usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_rb_vm_struct() {
    ...
    fn test_field_global_hooks() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_vm_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).global_hooks) as usize - ptr as usize
            },
            992usize,
            concat!(
                "Offset of field: ",
