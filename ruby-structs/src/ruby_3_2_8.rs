...
impl rb_method_definition_struct {
    ...
    pub unsafe fn type__raw(this: *const Self) -> rb_method_type_t {
        unsafe {
            ::std::mem::transmute(
                <__BindgenBitfieldUnit<[u8; 8usize]>>::raw_get_const::<0usize, 4u8>(
                    ::std::ptr::addr_of!((*this)._bitfield_1),
                ) as u32,
            )
        }
    ...
    pub unsafe fn set_type_raw(this: *mut Self, val: rb_method_type_t) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 8usize]>>::raw_set_const::<0usize, 4u8>(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
                val as u64,
            )
        }
    ...
    pub fn reference_count(&self) -> ::std::os::raw::c_int {
        unsafe { ::std::mem::transmute(self._bitfield_1.get_const::<32usize, 28u8>() as u32) }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub fn set_reference_count(&mut self, val: ::std::os::raw::c_int) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            self._bitfield_1.set_const::<32usize, 28u8>(val as u64)
        }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    ...
    pub unsafe fn set_reference_count_raw(this: *mut Self, val: ::std::os::raw::c_int) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 8usize]>>::raw_set_const::<32usize, 28u8>(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
                val as u64,
            )
        }
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set_const::<32usize, 28u8>({
...
impl rb_args_info {
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn no_kwarg_raw(this: *const Self) -> ::std::os::raw::c_uint {
        unsafe {
            ::std::mem::transmute(
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn set_no_kwarg_raw(this: *mut Self, val: ::std::os::raw::c_uint) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn forwarding_raw(this: *const Self) -> ::std::os::raw::c_uint {
        unsafe {
            ::std::mem::transmute(
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn set_forwarding_raw(this: *mut Self, val: ::std::os::raw::c_uint) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
...
impl rb_thread_struct {
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn locking_native_thread_raw(this: *const Self) -> ::std::os::raw::c_uint {
        unsafe {
            ::std::mem::transmute(
                <__BindgenBitfieldUnit<[u8; 1usize]>>::raw_get_const::<2usize, 1u8>(
                    ::std::ptr::addr_of!((*this)._bitfield_1),
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn set_locking_native_thread_raw(this: *mut Self, val: ::std::os::raw::c_uint) {
        unsafe {
            let val: u32 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 1usize]>>::raw_set_const::<2usize, 1u8>(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
