...
fn bindgen_test_layout_rb_call_info_kw_arg_struct() {
    ...
    fn test_field_keyword_len() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_call_info_kw_arg_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).keyword_len) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_keyword_len();
    fn test_field_keywords() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_call_info_kw_arg_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).keywords) as usize - ptr as usize
            },
            8usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_rb_call_info_struct() {
    ...
    fn test_field_kw_arg() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<rb_call_info_struct>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).kw_arg) as usize - ptr as usize
            },
            24usize,
            concat!(
                "Offset of field: ",
