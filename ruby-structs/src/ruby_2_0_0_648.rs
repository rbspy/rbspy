...
impl st_table {
    ...
    pub fn num_entries(&self) -> st_index_t {
        unsafe { ::std::mem::transmute(self._bitfield_1.get_const::<1usize, 63u8>() as u64) }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub fn set_num_entries(&mut self, val: st_index_t) {
        unsafe {
            ...
            self._bitfield_1.set_const::<1usize, 63u8>(val as u64)
        }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn num_entries_raw(this: *const Self) -> st_index_t {
        unsafe {
            ::std::mem::transmute(
                <__BindgenBitfieldUnit<[u8; 8usize]>>::raw_get_const::<1usize, 63u8>(
                    ::std::ptr::addr_of!((*this)._bitfield_1),
                ) as u64,
            )
        }
    ...
    pub unsafe fn set_num_entries_raw(this: *mut Self, val: st_index_t) {
        unsafe {
            let val: usize = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<[u8; 8usize]>>::raw_set_const::<1usize, 63u8>(
                ::std::ptr::addr_of_mut!((*this)._bitfield_1),
                val as u64,
            )
        }
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set_const::<1usize, 63u8>({
