...
pub type vm_call_handler =
    ::std::option::Option<
        unsafe extern "C" fn(ec: *mut rb_execution_context_struct,
...
fn bindgen_test_layout_rb_iseq_location_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_location_struct>())).code_range as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_location_struct),
...
fn bindgen_test_layout_rb_iseq_constant_body() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_constant_body>())).insns_info as *const _ as usize },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_constant_body),
...
fn bindgen_test_layout_rb_iseq_struct__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_iseq_struct__bindgen_ty_1>())).trace_events as *const _ as
                usize
        },
        0usize,
        concat!(
...
impl ::std::fmt::Debug for rb_vm_struct {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            ...
            self.thread_report_on_exception(),
            self.trace_running,
            self.sleeper,
...
fn bindgen_test_layout_rb_control_frame_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_control_frame_struct>())).block_code as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_control_frame_struct),
...
fn bindgen_test_layout_rb_execution_context_struct__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct__bindgen_ty_1>()))
                .stack_start as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct__bindgen_ty_1>())).stack_end as
                *const _ as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct__bindgen_ty_1>()))
                .stack_maxsize as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct__bindgen_ty_1>())).regs as
                *const _ as usize
        },
        24usize,
        concat!(
...
fn bindgen_test_layout_rb_execution_context_struct() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).vm_stack_size as *const _ as
                usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).interrupt_flag as *const _ as
                usize
        },
        48usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).interrupt_mask as *const _ as
                usize
        },
        56usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).local_storage as *const _ as
                usize
        },
        80usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>()))
                .local_storage_recursive_hash as *const _ as usize
        },
        88usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_execution_context_struct>())).errinfo as *const _ as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_execution_context_struct),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).passed_block_handler as
                *const _ as usize
        },
        144usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).passed_bmethod_me as
                *const _ as usize
        },
        152usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_execution_context_struct>())).method_missing_reason as
                *const _ as usize
        },
        160usize,
        concat!(
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_execution_context_struct>())).machine as *const _ as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_execution_context_struct),
