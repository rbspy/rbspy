...
fn bindgen_test_layout_st_table__bindgen_ty_1__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_table__bindgen_ty_1__bindgen_ty_1>())).head as *const _ as
                usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_table__bindgen_ty_1__bindgen_ty_1>())).tail as *const _ as
                usize
        },
        16usize,
        concat!(
...
#[repr(C)]
#[derive(Copy, Clone)]pub union RNode__bindgen_ty_1 { pub node : * mut RNode , pub id : ID , pub value : VALUE , pub cfunc : :: std :: option :: Option < unsafe extern "C" fn ( ) -> VALUE > , pub tbl : * mut ID , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union RNode__bindgen_ty_2 { pub node : * mut RNode , pub id : ID , pub argc : :: std :: os :: raw :: c_long , pub value : VALUE , _bindgen_union_align : u64 , }#[test]
...
#[repr(C)]
#[derive(Copy, Clone)]pub union RNode__bindgen_ty_3 { pub node : * mut RNode , pub id : ID , pub state : :: std :: os :: raw :: c_long , pub entry : * mut rb_global_entry , pub args : * mut rb_args_info , pub cnt : :: std :: os :: raw :: c_long , pub value : VALUE , _bindgen_union_align : u64 , }#[test]
...
fn bindgen_test_layout_rb_method_definition_struct__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_method_definition_struct__bindgen_ty_1>())).orig_me as
                *const _ as usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_rb_method_definition_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_method_definition_struct>())).type_ as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
impl ::std::fmt::Debug for rb_method_definition_struct {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "rb_method_definition_struct {{ type: {:?}, alias_count: {:?}, original_id: {:?}, body: {:?} }}",
            self.type_,
            self.alias_count,
            self.original_id,
            self.body
...
fn bindgen_test_layout_unlinked_method_entry_list_entry() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<unlinked_method_entry_list_entry>())).me as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(unlinked_method_entry_list_entry),
...
fn bindgen_test_layout_native_thread_data_struct() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<native_thread_data_struct>())).signal_thread_list as *const _ as
                usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_rb_call_info_kw_arg_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_info_kw_arg_struct>())).keywords as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_call_info_kw_arg_struct),
...
#[repr(C)]
#[derive(Copy, Clone)]pub union rb_call_info_struct__bindgen_ty_1 { pub opt_pc : :: std :: os :: raw :: c_int , pub index : :: std :: os :: raw :: c_int , pub missing_reason : :: std :: os :: raw :: c_int , pub inc_sp : :: std :: os :: raw :: c_int , _bindgen_union_align : u32 , }#[test]
fn bindgen_test_layout_rb_call_info_struct__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_call_info_struct__bindgen_ty_1>())).opt_pc as *const _ as
                usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_call_info_struct__bindgen_ty_1>())).missing_reason as
                *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_call_info_struct__bindgen_ty_1>())).inc_sp as *const _ as
                usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_rb_call_info_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_info_struct>())).method_state as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_call_info_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_info_struct>())).class_serial as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_call_info_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_call_info_struct>())).defined_class as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_call_info_struct),
...
impl ::std::fmt::Debug for rb_call_info_struct {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "rb_call_info_struct {{ mid: {:?}, flag: {:?}, orig_argc: {:?}, blockiseq: {:?}, kw_arg: {:?}, method_state: {:?}, class_serial: {:?}, klass: {:?}, me: {:?}, defined_class: {:?}, blockptr: {:?}, recv: {:?}, argc: {:?}, aux: {:?}, call: {:?} }}",
            self.mid,
            self.flag,
            self.orig_argc,
            self.blockiseq,
...
fn bindgen_test_layout_rb_iseq_struct__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_struct__bindgen_ty_1>())).flags as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_struct__bindgen_ty_1>())).size as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_struct__bindgen_ty_1),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<rb_iseq_struct__bindgen_ty_1>())).block_start as *const _ as
                usize
        },
        28usize,
        concat!(
...
fn bindgen_test_layout_rb_iseq_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_struct>())).defined_method_id as *const _ as usize },
        232usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_struct),
...
impl ::std::fmt::Debug for rb_vm_struct {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            ...
            self.progname,
            self.coverages,
            self.unlinked_method_entry_list,
