...
impl ::std::fmt::Debug for rb_method_definition_struct {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "rb_method_definition_struct {{ type: {:?}, original_id: {:?}, body: {:?}, alias_count: {:?} }}",
            self.type_,
            self.original_id,
            self.body,
            self.alias_count
...
fn bindgen_test_layout_iseq_inline_storage_entry__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<iseq_inline_storage_entry__bindgen_ty_1>())).done as *const _ as
                usize
        },
        16usize,
        concat!(
...
#[repr(C)]
#[derive(Copy, Clone)]pub union rb_call_info_struct__bindgen_ty_1 { pub opt_pc : :: std :: os :: raw :: c_int , pub index : :: std :: os :: raw :: c_long , pub missing_reason : :: std :: os :: raw :: c_int , pub inc_sp : :: std :: os :: raw :: c_int , _bindgen_union_align : u64 , }#[test]
...
impl ::std::fmt::Debug for rb_call_info_struct {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(
            f,
            "rb_call_info_struct {{ mid: {:?}, flag: {:?}, orig_argc: {:?}, blockiseq: {:?}, method_state: {:?}, class_serial: {:?}, klass: {:?}, me: {:?}, defined_class: {:?}, argc: {:?}, blockptr: {:?}, recv: {:?}, aux: {:?}, call: {:?} }}",
            self.mid,
            self.flag,
            self.orig_argc,
            self.blockiseq,
...
fn bindgen_test_layout_rb_iseq_struct() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_struct>())).arg_keyword_check as *const _ as usize },
        196usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_struct>())).arg_keyword_required as *const _ as usize },
        204usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<rb_iseq_struct>())).arg_keyword_table as *const _ as usize },
        208usize,
        concat!(
            "Offset of field: ",
            stringify!(rb_iseq_struct),
